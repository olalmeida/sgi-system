...
interface TransactionFormProps {
    onSubmit: (transaction: Omit<Transaction, 'id' | 'created_at' | 'created_by'>) => Promise<{ error: string | null }>;
    onUpdate?: (id: string, updates: Partial<Omit<Transaction, 'id' | 'created_at' | 'created_by'>>) => Promise<{ error: string | null }>;
    onClose: () => void;
    transaction?: TransactionWithDetails | null;
}

export function TransactionForm({ onSubmit, onUpdate, onClose, transaction }: TransactionFormProps) {
        ...
        <div className="modal-overlay" onClick={handleClose}>
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit} className="auth-form">
                    ...
                    <div className="form-group">
                        <label>{t('finance.budget')} {t('budgets.optional')}</label>
                        <select
                        ...
                        {budgets.filter(b => b.currency_code === formData.currency_code).length === 0 && budgets.length > 0 && (
                            <small className="stat-label" style={{ color: '#f59e0b', marginTop: '0.5rem', display: 'block' }}>
