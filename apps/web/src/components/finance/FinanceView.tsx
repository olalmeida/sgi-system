...
export function FinanceView() {
    ...
    const { transactions, loading, createTransaction, updateTransaction, deleteTransaction } = useTransactions(50);
    ...
    const filteredTransactions = transactions.filter(transaction => {
        ...
        const matchesCurrency = filterCurrency === 'all' || transaction.currency_code === filterCurrency;
                        ...
                        <tbody>
                            {filteredTransactions.map((transaction) => (
                                <tr key={transaction.id}>
                                    ...
                                    <td style={{ color: transaction.type === 'income' ? 'var(--secondary)' : '#ef4444', fontWeight: 600 }}>
