...
export function SettingsView() {
  ...
  const { user } = useAuth();
  const [activeTab, setActiveTab] = useState<'preferences' | 'profile' | 'notifications' | 'data'>(
    'preferences'
  );
  ...
  const handleExportData = async () => {
    try {
      ...
      // Fetch all user data
      const [{ data: transactions }, { data: budgets }, { data: logistics }] = await Promise.all([
          ...
          <div className="settings-section">
            ...
            <div className="setting-item">
              ...
              <select
                ...
                onChange={(e) => handleLanguageChange(e.target.value as 'es' | 'en' | 'pt')}
            ...
            <div className="setting-item">
              ...
              <select
                ...
                onChange={(e) => handleCurrencyChange(e.target.value as 'USD' | 'EUR' | 'BRL')}
                className="setting-select"
              >
            ...
            <div className="setting-item">
              ...
              <select
                ...
                onChange={(e) =>
                  handleDateFormatChange(e.target.value as 'DD/MM/YYYY' | 'MM/DD/YYYY')
                }
                className="setting-select"
              >
        ...
        {activeTab === 'notifications' && (
          <div className="settings-section">
            ...
            <div className="setting-item">
              ...
              <label htmlFor="budget-alerts-toggle" className="toggle-switch">
                <span className="sr-only">{t('settings.budgetAlerts')}</span>
                <input
            ...
            {settings.budgetAlerts && (
              <div className="setting-item">
                ...
                <select
                  ...
                  onChange={(e) => handleThresholdChange(Number(e.target.value) as 70 | 80 | 90)}
                  className="setting-select"
                >
